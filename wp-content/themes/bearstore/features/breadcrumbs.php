...
<ul class="breadcrumb">
  <li>
	<a href="<?php echo home_url(); ?>" class="breadcrumb_home"><?php esc_html_e('Home',_THEME) ?></a> <span class="divider">/</span>
  </li>
  <li class="active">
		...
		<?php } elseif (is_author()) { ?>
			...
			?>
			<?php esc_html_e('Posts by ','beastore'); echo ' ',$curauth->nickname; ?>
		<?php } elseif (is_page()) { ?>
			<?php wp_title(''); ?>
	<?php } ?>  
  </li>
