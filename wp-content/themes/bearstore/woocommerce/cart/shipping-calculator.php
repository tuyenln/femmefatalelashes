...
<form class="shipping_calculator" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
	<h3><a href="#" class="shipping-calculator-button"><?php _e('Calculate Shipping', 'woocommerce'); ?> <span>&darr;</span></a></h3>
	...
	<section class="shipping-calculator-form">
		...
		<p class="form-row form-row-first">
			<label for="calc_shipping_country"><em>*</em> Country</label>
		...
		<p class="form-row form-row-first">
			<label for="calc_shipping_state">State/Province</label>
			<?php
		...
		<p class="form-row form-row-first">
			<label for="calc_shipping_postcode">Zip/Postal Code</label>
		...
		<p class="form-row form-row-last"><button type="submit" name="calc_shipping" value="1" class="button"><?php _e('Update Totals', 'woocommerce'); ?></button></p>
