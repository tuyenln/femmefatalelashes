...
<?php
	...
	if ( $count > 0 ) :
		...
		echo '<h4 id="comments">'.__('Reviews', 'woocommerce').'</h4>';
	...
	if ( have_comments() ) :
		...
		echo '<p class="add_review"><a href="#review_form" class="inline show_review_form btn btn-flat">'.__('Add Review', 'woocommerce').'</a></p>';
	...
	$comment_form['comment_field'] .= '<p class="comment-form-comment"><label for="comment">' . __( 'Your Review', 'woocommerce' ) . '</label><textarea class="span5" id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>' . $woocommerce->nonce_field('comment_rating', true, false);
