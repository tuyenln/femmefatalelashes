    ...
    class Helix {
        ...
        */
        final public static function getInstance()
        {
            ...
            if( !self::$_instance ){
                ...
                register_nav_menus(
                    array(
                        'primary' => __( 'Primary Menu','bearstore' )
                    )
                );
        ...
        public static function Header() {
            ...
            */
            ...
            if (self::getInstance()->Param('layout_mode')!='responsive') {
				if(self::getInstance()->Param('layout_width')){
					echo '<style tyle="text/css">.container {max-width: ' . self::getInstance()->Param('layout_width') . 'px;}</style>';
				} else {
					echo '<style tyle="text/css">.container {max-width: 980px;}</style>';
				}
        ...
        */
        public static function bootstrap() {
            ...
            self::getInstance()->addCSS( array('fontello.css' , 'animation.css'));
        ...
        */
        public static function mainWidth() {
            $left 	= self::getInstance()->Param('left_sidebar_width')?self::getInstance()->Param('left_sidebar_width'):'3';
            $right 	= self::getInstance()->Param('right_sidebar_width')?self::getInstance()->Param('right_sidebar_width'):'3';
            $width = 12;
            ...
            foreach($fieldset->field as $field)
            {
                ...
                switch((string)$field['type'])
                {
                    ...
                    case 'include':
                        ...
                        break;
                   case 'heading':
                   			$html .= '<div class="row-fluid"><div class="sp-inner">';
