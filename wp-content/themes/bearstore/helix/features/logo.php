...
<?php if (Helix::Param('logo_type')=='css') { ?>
	...
	<a id="logo" style="width:<?php echo Helix::Param('logo_width'); ?>px; height:<?php echo Helix::Param('logo_height'); ?>px" class="pagination-centered" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"></a>
